# ionic-capacitor-qualaroo-sdk

Ionic Bridge For Qualaroo Mobile SDK

## Install

```bash
npm install ionic-capacitor-qualaroo-sdk
npx cap sync
```
...
* [`setUserId(...)`](#setuserid)
* [`setUsetUserPropertyserId(...)`](#setusetuserpropertyserid)
...
**Returns:** <code>Promise&lt;{ apiKey: string; }&gt;</code>
...
| Param         | Type                                  |
| ------------- | ------------------------------------- |
| **`options`** | <code>{ surveyAlias: string; }</code> |

**Returns:** <code>Promise&lt;{ surveyAlias: string; }&gt;</code>
...
| Param         | Type                                                   |
| ------------- | ------------------------------------------------------ |
| **`options`** | <code>{ userId: <a href="#string">String</a>; }</code> |

**Returns:** <code>Promise&lt;{ userId: string; }&gt;</code>

--------------------


### setUsetUserPropertyserId(...)
...
| Param         | Type                                                                                     |
| ------------- | ---------------------------------------------------------------------------------------- |
| **`options`** | <code>{ key: <a href="#string">String</a>; value: <a href="#string">String</a>; }</code> |
...
| Param         | Type                                                |
| ------------- | --------------------------------------------------- |
| **`options`** | <code>{ key: <a href="#string">String</a>; }</code> |
...
| Param         | Type                                                         |
| ------------- | ------------------------------------------------------------ |
| **`options`** | <code>{ iso2Language: <a href="#string">String</a>; }</code> |

**Returns:** <code>Promise&lt;{ iso2Language: string; }&gt;</code>
